...
public class MessageServiceImpl extends ServiceImpl<MessageMapper, Message>
  ...
  private final PageOperation<Message> pageOperation = new PageOperation<>(logger);
  ...
  public List<MessageReceiveVo> read(long id, boolean all, PageReq pageReq) {
    ...
    List<Message> messageList = pageOperation.paginate(pageReq, queryWrapper, baseMapper);
